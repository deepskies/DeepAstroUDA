...
![](images/.....png)
<div align="center">
<sub>Example mock images of spiral (left), elliptical (middle) and merging galaxies (right) from SDSS and DECaLS surveys.</sub>
</div>

![](images/......png)
<div align="center">
<sub>Example t-SNE plots for model trained without (left) and with domain adaptation (right). </sub>
</div>
